...
POWERKIT_DEFAULT_HELPER_KEY="M-/"
POWERKIT_DEFAULT_HELPER_WIDTH="80%"
POWERKIT_DEFAULT_HELPER_HEIGHT="80%"
POWERKIT_DEFAULT_OPTIONS_KEY="M-?"  # Alt+? to avoid conflict with tmux default '?' (list-keys)
POWERKIT_DEFAULT_OPTIONS_WIDTH="80%"
POWERKIT_DEFAULT_OPTIONS_HEIGHT="80%"
POWERKIT_DEFAULT_KEYBINDINGS_KEY="M-b"  # Alt+b to avoid potential conflicts
...
POWERKIT_PLUGIN_AUDIODEVICES_INPUT_KEY="M-a"  # Alt+a (audio input)
POWERKIT_PLUGIN_AUDIODEVICES_OUTPUT_KEY="M-s"  # Alt+s (sound/speaker)
...
POWERKIT_PLUGIN_BLUETOOTH_MAX_LENGTH="40"
...
POWERKIT_PLUGIN_GITHUB_ACCENT_COLOR="$_DEFAULT_ACCENT"
POWERKIT_PLUGIN_GITHUB_ACCENT_COLOR_ICON="$_DEFAULT_ACCENT_ICON"
POWERKIT_PLUGIN_GITHUB_REPOS=""
...
POWERKIT_PLUGIN_GITHUB_TOKEN="${GITHUB_TOKEN:-}"  # Reads from environment variable
POWERKIT_PLUGIN_GITHUB_CACHE_TTL="300"
POWERKIT_PLUGIN_GITHUB_FORMAT="compact"
POWERKIT_PLUGIN_GITHUB_WARNING_THRESHOLD="10"
POWERKIT_PLUGIN_GITHUB_WARNING_ACCENT_COLOR="$_DEFAULT_WARNING"
POWERKIT_PLUGIN_GITHUB_WARNING_ACCENT_COLOR_ICON="$_DEFAULT_WARNING_ICON"
POWERKIT_PLUGIN_GITHUB_SEPARATOR=" | "

# --- gitlab ---
POWERKIT_PLUGIN_GITLAB_URL="https://gitlab.com"
POWERKIT_PLUGIN_GITLAB_ICON=$'\uf296' # GitLab icon
POWERKIT_PLUGIN_GITLAB_ACCENT_COLOR="$_DEFAULT_ACCENT"
POWERKIT_PLUGIN_GITLAB_ACCENT_COLOR_ICON="$_DEFAULT_ACCENT_ICON"
POWERKIT_PLUGIN_GITLAB_REPOS="gitlab-org/gitlab" # owner/repo
...
POWERKIT_PLUGIN_GITLAB_WARNING_ACCENT_COLOR="red"
POWERKIT_PLUGIN_GITLAB_WARNING_ACCENT_COLOR_ICON="$_DEFAULT_WARNING_ICON"

# --- bitbucket ---
POWERKIT_PLUGIN_BITBUCKET_URL="https://api.bitbucket.org/2.0"
POWERKIT_PLUGIN_BITBUCKET_ICON=$'\uf171' # Bitbucket icon
POWERKIT_PLUGIN_BITBUCKET_ACCENT_COLOR="$_DEFAULT_ACCENT"
POWERKIT_PLUGIN_BITBUCKET_ACCENT_COLOR_ICON="$_DEFAULT_ACCENT_ICON"
POWERKIT_PLUGIN_BITBUCKET_REPOS="workspace/repo_slug" # workspace/repo
...
POWERKIT_PLUGIN_BITBUCKET_TOKEN="" # username:app_password
POWERKIT_PLUGIN_BITBUCKET_CACHE_TTL="300"
POWERKIT_PLUGIN_BITBUCKET_WARNING_THRESHOLD="10"
POWERKIT_PLUGIN_BITBUCKET_WARNING_ACCENT_COLOR="red"
POWERKIT_PLUGIN_BITBUCKET_WARNING_ACCENT_COLOR_ICON="$_DEFAULT_WARNING_ICON"
...
POWERKIT_PLUGIN_KUBERNETES_SHOW_NAMESPACE="true"
...
POWERKIT_PLUGIN_KUBERNETES_CONTEXT_SELECTOR_KEY="M-k"  # Alt+k (kubernetes)
POWERKIT_PLUGIN_KUBERNETES_CONTEXT_SELECTOR_WIDTH="50%"
POWERKIT_PLUGIN_KUBERNETES_CONTEXT_SELECTOR_HEIGHT="50%"
POWERKIT_PLUGIN_KUBERNETES_NAMESPACE_SELECTOR_KEY="M-j"  # Alt+j (below k on keyboard)
...
POWERKIT_PLUGIN_FAN_SHOW_WHEN_UNAVAILABLE="false"  # If true, shows placeholder when RPM not available
POWERKIT_PLUGIN_FAN_PLACEHOLDER="--"              # Placeholder text when unavailable
...
POWERKIT_PLUGIN_TERRAFORM_WORKSPACE_KEY="M-t"  # Alt+t (terraform)
...
# Cache
POWERKIT_PLUGIN_CACHE_CLEAR_KEY="M-r"  # Alt+r (refresh)
