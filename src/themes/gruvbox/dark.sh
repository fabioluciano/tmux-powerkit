...
declare -A THEME_COLORS=(
    ...
    [secondary-subtle]="#645d5a"     # Subtle secondary (18.9% lighter)
    ...
    [disabled-subtle]="#7f756d"      # Subtle disabled (18.9% lighter)
    [disabled-strong]="#393430"      # Strong disabled (44.2% darker)
