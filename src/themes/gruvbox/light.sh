...
declare -A THEME_COLORS=(
    ...
    [secondary-subtle]="#7f756d"     # Subtle secondary (18.9% lighter)
    ...
    [disabled-subtle]="#cbc0a9"      # Subtle disabled (18.9% lighter)
    [disabled-strong]="#6a6152"      # Strong disabled (44.2% darker)
