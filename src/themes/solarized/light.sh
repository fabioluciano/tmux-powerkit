...
declare -A THEME_COLORS=(
    ...
    [secondary-subtle]="#72878e"     # Subtle secondary (18.9% lighter)
    ...
    [disabled-subtle]="#a9b5b5"      # Subtle disabled (18.9% lighter)
    [disabled-strong]="#525a5a"      # Strong disabled (44.2% darker)
